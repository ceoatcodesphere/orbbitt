...
export function GridBackgroundDemo() {
  ...
  return (
    <div className="min-h-full mt-20 flex flex-col justify-center items-center">
      ...
      <h1 className="font-bold text-xl md:text-6xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 py-4 mb-16">
        Connecting{" "}
        <span className="">
          Communities
        </span>
        <br />
        <span className="mt-4 block">Building Careers.</span>
      </h1>
