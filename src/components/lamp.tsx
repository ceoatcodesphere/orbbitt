  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-100 to-slate-200 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        What are you waiting for ? <br />  Let us get started
      </motion.h1>
      <a href="/search">  <button className="bg-blue-600 text-white px-6 py-3 rounded-full hover:bg-green-800">
            Get Started
          </button>
          </a> 
    </LampContainer>
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic  to-transparent text-white "
        >
